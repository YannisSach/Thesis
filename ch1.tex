...
In Chapters \ref{unbounded} \ref{bounded} the unbounded DPOR and bounded DPOR algorithms implemented and evaluated are
...
using both synthetic tests and real-world software (RCU). In Chapter \ref{Chapter 5} we present and evaluate an
alternative approach to the bounding problem. Finally, in Chapter \ref{Chapter 6} we summarize the previous chapters and
the conclusions we drew from this thesis, and present some possible extensions to our work.
