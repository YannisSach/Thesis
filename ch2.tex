...
\Code{./code/zero.c}{Non-concurrency error}
\Code{./code/zeroconc.c}{Concurrency error}

\section{Testing, Model Checking and Verification}

Dynamic software model checking consists of adapting model checking into a form of systematic testing that is applicable to industrial-size software. 
Over the last two decades, dozens of tools following this paradigm have been developed for checking concurrent and data-driven software. Compared to 
traditional software testing, dynamic software model checking provides better coverage, but is more computationally expensive. Compared to more general 
forms of program verification like interactive theorem proving, this approach provides more limited verification guarantees, but is cheaper due to its higher
...
The graph shown in Figure \ref{Comparing Testing, Model Checking and Verification} greatly demonstrates the differences between testing, model checking and verification.
