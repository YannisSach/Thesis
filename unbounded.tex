...
\subsection{Source-DPOR}
In this section Source-DPOR is presented. Even though Source-DPOR is posterior to Classic-DPOR, as the name suggests, we choose to present it first since any algorithm
...
\subsection{Comparison of Classic-DPOR and Source-DPOR}
...
algorithms are based on vector-clocks, in spite of the fact that their usage is implied in the Source-DPOR in line ? and line ? of Algorithm \ref{Source}.
...
\subsection{Combining Classic-DPOR and Source-DPOR}
